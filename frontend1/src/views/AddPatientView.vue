          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <label class="flex items-center space-x-2">
                  <input type="checkbox" v-model="form.conditions.hepatitis" class="rounded text-blue-600" @change="showHepatitisDropdown = form.conditions.hepatitis">
